...
<head>
    ...
    <link href="<?= base_url() . '/assets/'; ?>vendor/fontawesome-free-6.3.0/css/all.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>/user">
                <div class="sidebar-brand-icon">
                    <i class="fas fa-light fa-people-arrows"></i>
                </div>
                <div class="sidebar-brand-text mx-3">CR Manager</div>
            </a>
            ...
            <?php foreach ($menu as $m) : ?>
                ...
                <?php foreach ($subMenu as $sm) : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style="padding: 0rem 1rem;" href="<?= base_url() . '/' . $sm['url']; ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    task selanjutnya: <b>bikin list customer</b>, CRUD customer
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?= base_url() . '/assets/img/profile/' . $profile_picture; ?>">
                            </a>
    ...
    <script src="<?= base_url() . '/assets/'; ?>vendor/fontawesome-free-6.3.0/js/fontawesome.js"></script>
    ...
    <script>
        ...
        function previewImg() {
            ...
            // sampulLabel.textContent = profilepicture.files[0].name;
            const fileProfil = new FileReader();
            fileProfil.readAsDataURL(profilepicture.files[0]);
            // console.log(fileProfil.readAsDataURL(profilepicture.files[0]));
        ...
        $('.roleselect').on('change', function() {
            ...
            $.ajax({
                ...
                success: function() {
                    document.location.href = "<?= base_url() . '/admin/userrole'; ?>";
                }
            });
        });
    </script>
